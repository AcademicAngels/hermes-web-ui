export default {
  ...
  // 更新日志
  changelog: {
    new_0_5_0_1: '多配置支持：按活跃配置筛选使用量统计',
    new_0_5_0_2: '群聊上下文压缩支持多配置',
    new_0_5_0_3: '修复 Token 估算高估问题（移除 senderName，使用 charsPerToken 配置）',
    new_0_5_0_4: '改进 WSL 兼容性，自动检测并使用 WAL 模式',
    new_0_5_0_5: '增强 Hermes 会话同步的错误日志',
    new_0_5_0_6: '同步后自动清理临时会话',
